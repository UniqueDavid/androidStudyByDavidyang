...
public class MainActivity extends Activity {
	...
	public void login(View v) throws UnsupportedEncodingException{
		String path="http://192.168.1.100:8080/QQLogin/loginServlet";
		
		AsyncHttpClient client=new AsyncHttpClient();
	
		RequestParams params=new RequestParams();
		
		params.add("number", URLEncoder.encode(et_qqnumber.getText().toString().trim(),"utf-8"));
		params.add("password", URLEncoder.encode(et_qqpassword.getText().toString().trim(),"utf-8"));
